...
//                                                                           **
// Filename: Reactivity.UI.Panel.Swordfish\ChartUtilities.cs                          **
...
namespace Reactivity.UI.Panel.Swordfish
{
	...
	public static class ChartUtilities
	{
		...
		public static System.Drawing.Bitmap CopyFrameworkElementToBitmap(FrameworkElement copyTarget, double width, double height)
		{
			...
			using (MemoryStream outStream = CopyFrameworkElementToMemoryStream(copyTarget, width, height, new BmpBitmapEncoder()))
			{
		...
		/// <returns></returns>
		public static MemoryStream CopyFrameworkElementToMemoryStream(FrameworkElement copyTarget, double width, double height, BitmapEncoder enc)
		{
