...
namespace XDrawing.TestLab.FormPages
{
  ...
  public class GeneralPage : System.Windows.Forms.UserControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlBackground.Location = new System.Drawing.Point(108, 12);
      ...
      this.btnBackground.Location = new System.Drawing.Point(168, 24);
      ...
      // lblFillMode
      // 
      this.lblFillMode.Location = new System.Drawing.Point(16, 72);
      ...
      this.cbxFillMode.Items.AddRange(new object[] {
                                                     "Alternate (0)",
                                                     "Winding (1)"});
      this.cbxFillMode.Location = new System.Drawing.Point(92, 68);
      ...
      this.udTension.Increment = new System.Decimal(new int[] {
                                                                1,
                                                                0,
                                                                0,
                                                                65536});
      this.udTension.Location = new System.Drawing.Point(92, 100);
      this.udTension.Maximum = new System.Decimal(new int[] {
                                                              10,
                                                              0,
                                                              0,
                                                              0});
      ...
      // lblTension
      // 
      this.lblTension.Location = new System.Drawing.Point(16, 104);
      ...
      this.btnClear.Location = new System.Drawing.Point(140, 100);
      ...
      // lblPageUnit
      // 
      this.lblPageUnit.Location = new System.Drawing.Point(16, 132);
      ...
      this.cbxPageUnit.Items.AddRange(new object[] {
                                                     ...
                                                     "Millimeter (2)",
                                                     "Centimeter (3)"});
      this.cbxPageUnit.Location = new System.Drawing.Point(88, 128);
      ...
      // lblPageDirection
      // 
      this.lblPageDirection.Location = new System.Drawing.Point(16, 168);
      ...
      this.cbxPageDirection.Items.AddRange(new object[] {
                                                          "Downwards (0)",
                                                          "Upwards (1)"});
      this.cbxPageDirection.Location = new System.Drawing.Point(88, 164);
      ...
      // lblDirectionInfo
      // 
      this.lblDirectionInfo.Location = new System.Drawing.Point(212, 168);
    ...
    private void btnBackground_Click(object sender, System.EventArgs e)
    {
      try
      {
        ...
        {
          dialog.Owner = XGraphicsLab.mainForm;
