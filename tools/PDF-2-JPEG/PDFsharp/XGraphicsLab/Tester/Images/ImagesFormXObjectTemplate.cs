...
namespace XDrawing.TestLab.Tester
{
  ...
  public class ImagesFormXObjectTemplate : TesterBase
  {
    public override void RenderPage(XGraphics gfx)
    {
      ...
      formgfx.DrawString("Text", font, XBrushes.DarkOrange, 0, 0, XStringFormat.TopLeft);
      formgfx.DrawString("Text", font, XBrushes.DarkOrange, new XRect(0, 0, cx, cy), XStringFormat.Center);
